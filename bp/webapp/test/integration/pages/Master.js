		...
		onTheMasterPage : {
			...
			actions : {
				...
				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<Customer>", "<100 <Supplier>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<Customer> Group");
				},
			...
			assertions : {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("Customer", 100);
				},
